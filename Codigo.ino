const int Trigger1 = 13;   //Pin digital 2 para el Trigger del sensor
const int Echo1 = 12;   //Pin digital 3 para el Echo del sensor


const int Trigger2 = 7;   //Pin digital 8 para el Trigger del sensor
const int Echo2 = 6;   //Pin digital 9 para el Echo del sensor


const int Trigger3 = 3;   //Pin digital 11 para el Trigger del sensor
const int Echo3 = 2;   //Pin digital 12 para el Echo del sensor
